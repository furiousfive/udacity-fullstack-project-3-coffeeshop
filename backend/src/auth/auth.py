...
AUTH0_DOMAIN = 'jamaalsanders.auth0.com'
ALGORITHMS = ['RS256']
...
def check_permissions(permission, payload):
    ...
    Middleware that checks to user has permission to to requested
    action.
...
def verify_decode_jwt(token):
    ...
    Auth Middleware decodes JWT and verify and validate the token.
    Return a decoded payload
